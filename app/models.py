...
class DN(Base):
    ...
    remark = Column(Text, nullable=True)
    photo_url = Column(Text, nullable=True)
    lng = Column(String(256), nullable=True)
    lat = Column(String(256), nullable=True)
    created_at = Column(DateTime(timezone=True), server_default=func.now(), nullable=False)
    status_wh = Column(String(256), nullable=True)
    lsp = Column(String(256), nullable=True)
    ...
    driver_contact_name = Column(String(256), nullable=True)
    ...
    lsp_tracker = Column(String(256), nullable=True)
    hw_tracker = Column(String(256), nullable=True)
    actual_depart_from_start_point_atd = Column(Text, nullable=True)
    actual_arrive_time_ata = Column(Text, nullable=True)
    subcon = Column(String(256), nullable=True)
    subcon_receiver_contact_number = Column(String(256), nullable=True)
